...
<head>
    ...
    <title>Nota Transaksi #<?php echo e($order->id); ?></title>
...
<body>
    ...
    <div class="no-print text-center mt-4">
        ...
        <a href="<?php echo e(route('order.status', $order->id)); ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="nota-box shadow-sm">
        ...
        <div class="text-center mb-3 border-bottom pb-2">
            ...
            <small class="text-muted">No. Nota: #<?php echo e($order->id); ?> | <?php echo e($order->created_at->format('d/m/Y H:i')); ?></small>
        </div>

        <div class="mb-3 small">
            <div><strong>Pelanggan:</strong> <?php echo e($order->customer_name); ?></div>
            <div><strong>Metode Bayar:</strong> <?php echo e($order->payment_method ?? 'Bayar di Kasir (Tunai/QRIS)'); ?></div>
        </div>
        ...
        <table class="table table-borderless table-sm small border-top border-bottom my-2 py-2">
            <tbody>
                <tr>
                    <td>Cetak (<?php echo e($order->total_pages); ?> Hal x <?php echo e($copies); ?> Copy)</td>
                    <td class="text-end">Rp <?php echo e(number_format($biayaCetak, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td>Jilid (<?php echo e(ucfirst($order->binding_type)); ?> x <?php echo e($copies); ?>)</td>
                    <td class="text-end">
                        Rp <?php echo e(number_format($biayaJilidTotal, 0, ',', '.')); ?>
        ...
        <div class="text-center mt-4 border-top pt-3 text-muted extra-small" style="font-size: 11px;">
            ...
            <p class="mb-0">Perkiraan Selesai: <strong><?php echo e($order->created_at->addMinutes($order->estimated_duration_minutes)->format('H:i')); ?> WIB</strong></p>
        </div>
    </div>

</body>
</html><?php /**PATH C:\laragon\www\fotokopi111\resources\views/nota.blade.php ENDPATH**/ ?>